...
LANEWIDTH = 3.3  # highway lane width in US: 3.7 meters
input_scale = 4
...
x = [311, 995, 745, 600]
y = [707, 707, 480, 480]
X = [395, 850, 850, 395] #warped dimensions
Y = [719, 719, 0, 0]
...
s_thresh, sx_thresh, dir_thresh, m_thresh, r_thresh = (0,50), (20, 100), (0.7, 1.3), (30, 100), (200, 255)
...
def abs_sobel_thresh(img, orient='x', sobel_kernel=3, thresh=(0, 255)):
    ''' threshold using the sobel operator
...
def create_output_frame(offcenter, pts, undist_ori, fps, curvature, curve_direction, binary_sub, threshold=0.6):
    ...
    whole_frame[20:20+h, 20:20+w, :] = undist_ori
    whole_frame[20:20+h, 60+w:60+2*w, :] = output
    ...
    cv2.putText(whole_frame, info_lane, (40+w+30,70+35+40+h), font, 0.8, (255,255,0), 1,cv2.LINE_AA)
    cv2.putText(whole_frame, info_cur, (40+w+90,70+35+80+h), font, 0.8, (255,255,0), 1,cv2.LINE_AA)
    cv2.putText(whole_frame, info_offset, (40+w+140,70+35+120+h), font, 0.8, (255,255,0), 1,cv2.LINE_AA)
    cv2.putText(whole_frame, info_framerate, (40+w+250,70), font, 0.6, (255,255,0), 1,cv2.LINE_AA)

    return whole_frame

def create_output_frame_short(offcenter, pts, undist_ori, fps, curvature, curve_direction, binary_sub, threshold=0.6):
    """
...
def process_frame(img, visualization=False):
    ...
    output2 = create_output_frame_short(offcenter, pts, img_undist_, fps, curvature, curve_direction, binary_sub)
    return output, lane_departure, output2
